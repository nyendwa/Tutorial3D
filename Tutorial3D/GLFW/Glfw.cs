...
namespace GLFW
{
    ...
    public static class Glfw
    {
        ...
        internal static Window CreateWindow(int width, int height, string title, object none1, Window none2)
        {
        ...
        internal static readonly object monitor;
        ...
        public static object Monitor { get; internal set; }
